...
function WeaponFactoryManager:get_stats(factory_id, blueprint)
	if not factory_id then
		return fs_original_weaponfactorymanager_getstats(self, factory_id, blueprint)
	end
...
function WeaponFactoryManager:has_perk(perk_name, factory_id, blueprint)
	if not factory_id then
		return fs_original_weaponfactorymanager_hasperk(self, perk_name, factory_id, blueprint)
	end
...
function WeaponFactoryManager:get_perk_stats(perk_name, factory_id, blueprint)
	if not factory_id then
		return fs_original_weaponfactorymanager_getperkstats(self, perk_name, factory_id, blueprint)
	end
