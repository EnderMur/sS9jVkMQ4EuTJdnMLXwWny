if not _G.MHiCS then
	...
	if CCSD.settings.CCSD_slider_value ~=nil then
		MHiCS.GanhoMissao = CCSD.recompensa_base[CCSD.settings.CCSD_slider_value]	
	else MHiCS.GanhoMissao = 15	
	end
	
	MHiCS.heists = {
		branchbank_cash = {assign = {1,2}, value = MHiCS.GanhoMissao},
		cage = {assign = {1}, value = MHiCS.GanhoMissao},
		kosugi = {assign = {1}, value = MHiCS.GanhoMissao},
		dark = {assign = {1}, value = MHiCS.GanhoMissao},
		firestarter_2 = {assign = {1,2}, value = MHiCS.GanhoMissao},
		firestarter_3 = {assign = {3}, value = MHiCS.GanhoMissao},
		hox_3 = {assign = {1,2}, value = MHiCS.GanhoMissao},
		fish = {assign = {1}, value = MHiCS.GanhoMissao},
		election_day_2 = {assign = {1,2}, value = MHiCS.GanhoMissao},
		crojob1 = {assign = {1,2}, value = MHiCS.GanhoMissao},
		framing_frame_1	= {assign = {3}, value = MHiCS.GanhoMissao},
		framing_frame_2	= {assign = {3}, value = MHiCS.GanhoMissao},
		framing_frame_3 = {assign = {1,2}, value = MHiCS.GanhoMissao},
		arm_for = {assign = {1,2}, value = MHiCS.GanhoMissao},
		friend = {assign = {1,2}, value = MHiCS.GanhoMissao},
		big = {assign = {1,3}, value = MHiCS.GanhoMissao},
		mus = {assign = {1,2,3}, value = MHiCS.GanhoMissao},
		roberts = {assign = {1,2,3}, value = MHiCS.GanhoMissao},
		red2 = {assign = {1,2,3}, value = MHiCS.GanhoMissao},
		arena = {assign = {1,3}, value = MHiCS.GanhoMissao},
		tag = {assign = {1}, value = MHiCS.GanhoMissao},
		vit = {assign = {1,3}, value = MHiCS.GanhoMissao},
		family = {assign = {1,2}, value = MHiCS.GanhoMissao},
		kenaz = {assign = {1,3}, value = MHiCS.GanhoMissao},
		jewelry_store = {assign = {1,2}, value = MHiCS.GanhoMissao},
		ukrainian_job = {assign = {1,2}, value = MHiCS.GanhoMissao},
		gallery = {assign = {1,2}, value = MHiCS.GanhoMissao},
		welcome_to_the_jungle_1_d = {assign = {1,2}, value = MHiCS.GanhoMissao},
		dah = {assign = {1,2}, value = MHiCS.GanhoMissao},
		sah = {assign = {1,2}, value = MHiCS.GanhoMissao},
		nightclub = {assign = {1,2}, value = MHiCS.GanhoMissao},
		election_day_1 = {assign = {1}, value = MHiCS.GanhoMissao},
		wwh = {assign = {2}, value = MHiCS.GanhoMissao-1},
		rvd_1 = {assign = {2}, value = MHiCS.GanhoMissao-1},
		rvd_2 = {assign = {2,3}, value = MHiCS.GanhoMissao},
		brb = {assign = {2}, value = MHiCS.GanhoMissao-1},
		arm_cro = {assign = {2}, value = MHiCS.GanhoMissao-1},
		help = {assign = {2}, value = MHiCS.GanhoMissao-1},
		arm_und = {assign = {2}, value = MHiCS.GanhoMissao-1},
		arm_hcm = {assign = {2}, value = MHiCS.GanhoMissao-1},
		arm_par = {assign = {2}, value = MHiCS.GanhoMissao-1},
		arm_fac = {assign = {2}, value = MHiCS.GanhoMissao-1},
		chew = {assign = {2}, value = MHiCS.GanhoMissao-1},
		firestarter_1 = {assign = {2}, value = MHiCS.GanhoMissao-1},
		nail = {assign = {2}, value = MHiCS.GanhoMissao-1},
		watchdogs_1_d = {assign = {2}, value = MHiCS.GanhoMissao-1},
		pines = {assign = {2}, value = MHiCS.GanhoMissao-1},
		moon = {assign = {2}, value = MHiCS.GanhoMissao-1},
		spa = {assign = {2}, value = MHiCS.GanhoMissao-1},
		cane = {assign = {2}, value = MHiCS.GanhoMissao-1},
		mia_2 = {assign = {2}, value = MHiCS.GanhoMissao-1},
		mad = {assign = {2,3}, value = MHiCS.GanhoMissao},
		mallcrasher = {assign = {2}, value = MHiCS.GanhoMissao-1},
		shoutout_raid = {assign = {2}, value = MHiCS.GanhoMissao-1},
		election_day_3 = {assign = {2}, value = MHiCS.GanhoMissao-1},
		watchdogs_2_d = {assign = {2}, value = MHiCS.GanhoMissao-1},
		pbr2 = {assign = {2,3}, value = MHiCS.GanhoMissao},
		pal = {assign = {2,3}, value = MHiCS.GanhoMissao},
		flat = {assign = {3}, value = MHiCS.GanhoMissao},
		born = {assign = {2,3}, value = MHiCS.GanhoMissao},
		hox_2 = {assign = {3}, value = MHiCS.GanhoMissao},
		hox_1 = {assign = {2,3}, value = MHiCS.GanhoMissao},
		welcome_to_the_jungle_2 = {assign = {3}, value = MHiCS.GanhoMissao},
		mia_1 = {assign = {2,3}, value = MHiCS.GanhoMissao},
		rat = {assign = {3}, value = MHiCS.GanhoMissao},
		pbr = {assign = {2,3}, value = MHiCS.GanhoMissao},
		glace = {assign = {3}, value = MHiCS.GanhoMissao},
		run = {assign = {3}, value = MHiCS.GanhoMissao},
		man = {assign = {2,3}, value = MHiCS.GanhoMissao},
		dinner = {assign = {3}, value = MHiCS.GanhoMissao},
		jolly = {assign = {3}, value = MHiCS.GanhoMissao},
		chill_combat = {assign = {3}, value = MHiCS.GanhoMissao},
		crojob2_d = {assign = {3}, value = MHiCS.GanhoMissao},
		bph = {assign = {3}, value = MHiCS.GanhoMissao},
		nmh = {assign = {3}, value = MHiCS.GanhoMissao},
		des = {assign = {3}, value = MHiCS.GanhoMissao},
		peta_1 = {assign = {3}, value = MHiCS.GanhoMissao},
		peta_2 = {assign = {3}, value = MHiCS.GanhoMissao},
		hvh = {assign = {2,3}, value = MHiCS.GanhoMissao},
		alex_1 = {assign = {2,	3}, value = MHiCS.GanhoMissao},
		alex_2 = {assign = {2,3}, value = MHiCS.GanhoMissao},
		alex_3 = {assign = {3}, value = MHiCS.GanhoMissao},
		haunted = {assign = {3}, value = MHiCS.GanhoMissao},
		mex = {assign = {1,3}, value = MHiCS.GanhoMissao},
		mex_cooking = {assign = {2}, value = MHiCS.GanhoMissao-1},
		bex = {assign = {1,2}, value = MHiCS.GanhoMissao},
		pex = {assign = {1,2}, value = MHiCS.GanhoMissao},
		fex = {assign = {1,2,3}, value = MHiCS.GanhoMissao},
		chas = {assign = {1,2,3}, value = MHiCS.GanhoMissao},
		four_stores = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_arena = {assign = {2,3}, value = MHiCS.GanhoMissao},
		skm_bex = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_big2 = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_cas = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_mallcrasher = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_mus = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_red2 = {assign = {3}, value = MHiCS.GanhoMissao},
		skm_run	= {assign = {3}, value = MHiCS.GanhoMissao},
		skm_watchdogs_stage2 = {assign = {3}, value = MHiCS.GanhoMissao}
	}
...
Hooks:PostHook(CrimeSpreeTweakData,"init_missions", "MHiCS_CrimeSpreeTweakData_init_missions", function(self, tweak_data)
	...
	MHiCS_add_mission_to(MHiCS, tweak_data, "mex", "mex", "csm_mex")
	MHiCS_add_mission_to(MHiCS, tweak_data, "mex_cooking", "mex_cooking", "csm_mex_cooking")
	...
	MHiCS_add_mission_to(MHiCS, tweak_data, "bex", "bex", "csm_bex")
	...
	MHiCS_add_mission_to(MHiCS, tweak_data, "pex", "pex", "csm_pex")
	MHiCS_add_mission_to(MHiCS, tweak_data, "fex", "fex", "csm_fex")
	MHiCS_add_mission_to(MHiCS, tweak_data, "chas", "chas", "csm_chas")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_arena", "skm_arena", "csm_skm_arena")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_bex", "skm_bex", "csm_skm_bex")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_big2", "skm_big2", "csm_skm_big2")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_cas", "skm_cas", "csm_skm_cas")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_mallcrasher", "skm_mallcrasher", "csm_skm_mallcrasher")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_mus", "skm_mus", "csm_skm_mus")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_red2", "skm_red2", "csm_skm_red2")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_run", "skm_run", "csm_skm_run")
	MHiCS_add_mission_to(MHiCS, tweak_data, "skm_watchdogs_stage2", "skm_watchdogs_stage2", "csm_watchdogs_stage2")
